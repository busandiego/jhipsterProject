...
/**
 * REST controller for managing {@link com.wmes.appserver.domain.Position}.
 */
@RestController
@RequestMapping("/api")
public class PositionResource {
    ...
    private static final String ENTITY_NAME = "wmesPosition";
    ...
    public List<PositionDTO> getAllPositions(@RequestParam(required = false) String filter) {
        if ("employee-is-null".equals(filter)) {
            log.debug("REST request to get all Positions where employee is null");
            return positionService.findAllWhereEmployeeIsNull();
        }
