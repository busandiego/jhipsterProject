...
/**
 * REST controller for managing {@link com.wmes.appserver.domain.Department}.
 */
@RestController
@RequestMapping("/api")
public class DepartmentResource {
    ...
    private static final String ENTITY_NAME = "wmesDepartment";
    ...
    public List<DepartmentDTO> getAllDepartments(@RequestParam(required = false) String filter) {
        if ("employee-is-null".equals(filter)) {
            log.debug("REST request to get all Departments where employee is null");
            return departmentService.findAllWhereEmployeeIsNull();
        }
